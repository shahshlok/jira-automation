        ...
        <div className="h-screen bg-gray-50 flex overflow-hidden">
                                ...
                                <div className="p-8">
                                    <div className="mb-6">
                                        ...
                                        <p className="text-gray-600">
                                            Click on an epic to explore its
                                            stories
                                        </p>
                                    </div>
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        {selectedEpic.stories.map((story) => {
                                            const storyTestCases =
                                                testCasesByStory[story.key] ||
                                                [];
                                            const storyStats =
                                                storyTestCases.reduce(
                                                    (acc, tc) => {
                                                        const status =
            ...
            <Dialog open={wizardOpen} onOpenChange={setWizardOpen}>
                <DialogTrigger asChild>
                    <Button className="fixed bottom-6 right-6 w-16 h-16 rounded-full bg-emerald-600 hover:bg-emerald-700 shadow-lg p-2 [&_svg]:!w-9 [&_svg]:!h-9">
